...
"""
Extract background from videos using Gaussian Mixture Model for background subtraction
...
def process_video_gmm(video_path, num_frames=100, history=500, var_threshold=16):
    ...
    return background_rgb, fps, frame_height, frame_width, total_frames
...
def write_video_file(
    target_path, background, fps, frame_width, frame_height, total_frames
):
    bg_video_frames = []
...
def main():
    ...
    parser.add_argument(
        "--target_dir",
        type=str,
        default="/home/kukushkin/imslowfast/dataset/bg_videos",
    ...
    for video_id in video_ids:
        ...
        try:
            background, fps, frame_height, frame_width, total_frames = (
        ...
        try:
            write_video_file(
                target_dir, background, fps, frame_width, frame_height, total_frames
            )
        except:
